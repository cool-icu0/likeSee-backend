...
import com.cool.likeSee.common.ErrorCode;
import com.cool.likeSee.exception.BusinessException;
import com.cool.likeSee.model.domain.User;
import com.cool.likeSee.service.UserService;
import com.cool.likeSee.mapper.UserMapper;
import com.cool.likeSee.utils.AlgorithmUtils;
...
import static com.cool.likeSee.contant.UserConstant.ADMIN_ROLE;
import static com.cool.likeSee.contant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     */
    @Override
    public int updateUser(User user, User logininUser) {
        ...
        //如果是管理员，允许更新任意用户
        //如果不是管理员，只允许更新自己的信息
        if (!isAdmin(logininUser) && userId != logininUser.getId()) {
     ...
     * @return
     */
    public boolean isAdmin(User logininUser) {
        return logininUser != null && logininUser.getUserRole() == ADMIN_ROLE;
    }
    ...
    public List<User> matchUsers(long num, User logininUser) {
        ...
        for (int i = 0; i < userList.size(); i++) {
            ...
            // 无标签或者为当前用户自己
            if (StringUtils.isBlank(userTags) || user.getId() == logininUser.getId()) {
                continue;
            }
